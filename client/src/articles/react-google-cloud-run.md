...
The `Dockerfile` tells our `CI/CD` to build a production version of our website, then to use `nginx` as a reverse proxy to serve these files over the internet.
